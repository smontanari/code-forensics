...
describe('DataSourceHandler', function() {
  ...
  it('returns data from an object stream', function(done) {
  ...
  it('returns data from a generated object stream', function(done) {
    var inputStream = new stream.PassThrough({ objectMode: true });
  ...
  it('fails if the data source has an error ', function(done) {
    var inputStream = new stream.PassThrough({ objectMode: true });
