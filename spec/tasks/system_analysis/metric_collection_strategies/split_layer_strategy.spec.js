  ...
  describe('metrics collection', function() {
        ...
        collectFn(timePeriod)
          ...
          .on('end', function() {
            expect(data).toEqual([
              ...
              jasmine.objectContaining({ name: 'Test Layer 2', metric1: 50, metric2: 25, date: '2010-05-31T00:00:00.000Z' })
            ]);
    ...
    beforeEach(function() {
      ...
      collectFn = splitLayerStrategy(
        ...
        new LayerGrouping([{ name: 'Test Layer 1' }, { name: 'Test Layer 2' }])
      );
    });
    ...
    describe('Layer aggregated metrics', function() {
      beforeEach(function() {
        streamsData = [
          ...
          [
            { path: 'Test Layer 2', testMetricA: 50, testMetricB: 'xyz', testMetricC: 25 }
          ]
        ];
      });
      assertStream();
