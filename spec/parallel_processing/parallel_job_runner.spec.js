...
describe('ParallelJobRunner', function() {
  describe('.addJob()', function() {
    ...
    it('executes added jobs up to the max number of concurrent jobs', function(done) {
      ...
      var job1 = jasmine.createSpy('jobFn1').and.returnValue(Q.delay(100)),
          job2 = jasmine.createSpy('jobFn2').and.returnValue(Q.delay(100)),
          job3 = jasmine.createSpy('jobFn3').and.returnValue(Q.delay(100));
