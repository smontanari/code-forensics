...
describe('StreamProcessor', function() {
  ...
  describe('merge a list of generated streams', function() {
    it('completes returning the merged stream', function(done) {
      var streamsData = [
        ['abc', 'xyz'],
        [123, 456, 789],
        [{ p1: 'qwe', p2: 'zxc' }, { p: 'ASD' }]
    ...
    it('skips any failed stream', function(done) {
      var streamsData = [
        ['abc', 'xyz'],
        [123, null],
        [{ p1: 'qwe', p2: 'zxc' }, { p: 'ASD' }]
  ...
  describe('process a list of generated streams', function() {
    it('completes returning the success/failure of every processed stream', function(done) {
  ...
  describe('process a single generated stream', function() {
    it('completes successfully the processing of the stream', function(done) {
    ...
    it('fails the processing of the stream', function(done) {
      var s = stream.PassThrough({ objectMode: true });
  ...
  describe('read a single generated stream', function() {
    it('reads the content of the stream', function(done) {
      var s = stream.PassThrough({ objectMode: true });
