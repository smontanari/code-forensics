...
module.exports = function(taskDef, context, helpers) {
  taskDef.add('system-evolution-analysis',
    {
      description: 'Analyise the evolution and the coupling in time of different parts of your system',
      parameters: [{ name: 'boundary', required: true }, { name: 'frequency' }]
    }, ['vcs-log-dump', 'generate-boundaries-file'], function() {
