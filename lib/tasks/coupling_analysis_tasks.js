...
module.exports = function(taskDef, context, helpers) {
  taskDef.add('sum-of-coupling-analysis', { description: 'Analyse the sum of coupling for each file' }, ['vcs-log-dump'], function() {
  ...
  taskDef.add('temporal-coupling-analysis',
    {
      description: 'Analyse the evolution of coupling in time for a particular file',
      parameters: [{ name: 'targetFile', required: true }, { name: 'frequency' }]
    }, ['vcs-log-dump', 'sloc-report'], function() {
