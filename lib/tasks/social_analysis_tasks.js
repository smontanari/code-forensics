  ...
  return {
    tasks: function() {
      taskDef.addAnalysisTask('commit-message-analysis',
        ...
        }, gulp.parallel(vcsFunctions.vcsCommitMessages));
      ...
      taskDef.addAnalysisTask('developer-effort-analysis',
        {
          ...
          run: function(publisher) {
            return utils.json.fileToObject(helpers.files.effort()).then(function(data) {
              ...
              return Bluebird.all(allDatafiles);
            });
          }
        }, gulp.parallel(codeMaatFunctions.effortReport));
      ...
      taskDef.addAnalysisTask('developer-coupling-analysis',
        ...
        }, gulp.parallel(codeMaatFunctions.authorsReport, codeMaatFunctions.codeOwnershipReport));
      ...
      taskDef.addAnalysisTask('knowledge-map-analysis',
        ...
        }, gulp.parallel(codeFunctions.slocReport, codeMaatFunctions.mainDevReport));
    }
  };
};
