...
module.exports = function(taskDef, context, helpers) {
  taskDef.add('commit-message-analysis',
    {
      description: 'Analyse the frequency of commit message words',
      parameters: [{ name: 'dateFrom' }, { name: 'dateTo' }, { name: 'frequency' }]
    }, ['vcs-commit-messages'], function() {
    return helpers.report.publish('commit-messages', function(publisher) {
  ...
  taskDef.add('authors-coupling-analysis',
    {
    ...
    }, ['authors-report', 'code-ownership-report'], function() {
