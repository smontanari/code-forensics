...
module.exports = function(taskDef, context, helpers) {
  ...
  taskDef.add('hotspot-analysis', { description: 'Perform a code hotspot detection combining code and revision analysis' }, ['code-analysis', 'revisions-report'], publishHotspotReport);
};
