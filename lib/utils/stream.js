...
module.exports = {
  ...
  reduceToObjectStream: function(parseFn) {
    ...
    return through2.obj(
      ...
      function(callback) {
        if (chunks.length > 0) {
          var obj = parseFn(Buffer.concat(chunks));
