...
var readConfigFromEnv = function() {
  ...
  return {
    ...
    codeMaatOptions: _.isString(codeMaatOptions) ? utils.arrayPairsToObject(codeMaatOptions.split(' ')) : undefined
  };
};

var singletonConfig = _.defaults(readConfigFromEnv(), readConfigFromFile(), DEFAULT_CONFIG);

module.exports = {
  get: function(property) {
    return singletonConfig[property];
  }
};
