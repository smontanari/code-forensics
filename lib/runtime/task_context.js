...
module.exports = {
  TaskContext: function(configuration, parameters) {
    ...
    this.boundaryDefinition = {
      name: parameters.boundary,
      boundaries: (configuration.architecturalBoundaries || {})[parameters.boundary]
    };

    this.targetFile = parameters.targetFile;
    this.frequency = parameters.frequency;
    this.maxCoupledFiles = parameters.maxCoupledFiles || 5;
    this.helpTaskName = parameters.taskName;
