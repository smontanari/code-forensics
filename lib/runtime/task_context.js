var Path       = require('path'),
    ...
    timePeriod = require('../time_interval/time_period_builder'),
...
module.exports = {
  TaskContext: function(configuration, parameters) {
    ...
    this.timePeriods = new timePeriod.TimePeriodBuilder(configuration.dateFormat)
    ...
    this.jobRunner = new pp.JobRunner(appConfig.maxConcurrency);
