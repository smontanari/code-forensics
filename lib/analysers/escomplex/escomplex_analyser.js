...
module.exports = function() {
  var jsParser;
  var javascriptParserConfig = appConfig.get('javascriptParser');
  if (_.isPlainObject(javascriptParserConfig) && _.isString(javascriptParserConfig.module)) {
    jsParser = Parser.create(javascriptParserConfig.module, javascriptParserConfig.options);
  }
