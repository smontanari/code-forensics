  ...
  this.chartDefinitions = [
    {
      name: 'yAxis',
      properties: {
        attributes: { class: 'fixed opaque', width: configuration.style.width - configuration.style.margin.right, height: configuration.style.margin.top },
      },
      components: [
        {
          name: 'yAxis',
    ...
    },
    {
      ...
      properties: {
        attributes: { class: 'bar-chart', width: configuration.style.width, height: actualHeight },
      },
      components: [
        {
          name: 'bars-plot',
