...
module.exports = function(configuration, nodesArray) {
  ...
  var allValues = _.uniqBy(_.map(allLeafNodes, nodeHelper.nodeValue.bind(nodeHelper)));
          ...
          graphicElements: [
            {
              ...
              properties: {
                ...
                style: {
                  ...
                  fill: function(node) {
                    if (node.isLeaf()) {
                      return colorScale(nodeHelper.nodeValue(node));
                    }
                ...
                properties: {
                  style: {
                    ...
                    'fill-opacity': function(node) {
                      if (node.isLeaf()) {
                        if (highlightedValue() !== null && highlightedValue() !== nodeHelper.nodeValue(node)) {
                          return 0.05;
                        }
                      }
                    }
