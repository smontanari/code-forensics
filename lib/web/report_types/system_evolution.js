    ...
    graphModels: [
      {
        ...
        diagram: {
          ...
          configuration: {
            ...
            series: {
              x: { axisLabel: 'Time', scale: d3.scaleTime(), valueProperty: 'date', valueCompareFn: function(date) { return date.getTime(); } },
              y: { axisLabel: 'Revisions', scale: d3.scaleLinear(), valueProperty: 'revisions' },
            }
          },
