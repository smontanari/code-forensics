  ...
  return {
    ...
    graphModels: _.map([
      ...
      return {
        ...
        controlTemplates: {
          filters: [
            { id: 'metric-range-filters', file: 'metric_range_filters_control_template.html' },
            { id: 'color-map-filters', file: 'color_map_filters_control_template.html' }
          ]
        },
        viewTemplates: [
          { id: 'circle-pack-tooltip', file: 'circle_pack_tooltip_template.html' }
        ],
        diagram:{
          Model: Model,
          ...
          filters: {
            valueFilter: {
              instance: new filters.MetricRange('Lines of code'),
              group: 'metricRange',
            ...
            colorFilter: {
              instance: new filters.ColorRange('Developers'),
              group: 'colorRange',
              dataTransform: function(series) {
                return _.uniqBy(
